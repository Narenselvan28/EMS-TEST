    ...
    return (
        <div className="h-72 bg-white mx-5 rounded-xl overflow-x-auto">
            <div className="min-w-[1400px]">
                <table className="min-w-full bg-white rounded-xl text-base shadow-sm border border-indigo-200">
                    <thead className="bg-[#5C53DE] text-white">
                        <tr>
                            <th className="px-4 py-3 text-left border border-indigo-200 w-[300px]">Item Name</th>
                            <th className="px-2 py-3 text-center border border-indigo-200 w-[80px]">Qty</th>
                            <th className="px-2 py-3 text-center border border-indigo-200 w-[150px]">UOM</th>
                            <th className="px-2 py-3 text-center border border-indigo-200 w-[100px]">Price</th>
                            <th className="px-2 py-3 text-center border border-indigo-200 w-[120px]">Amount</th>
                            <th className="px-2 py-3 text-center border border-indigo-200 w-[100px]">CGST %</th>
                            <th className="px-2 py-3 text-center border border-indigo-200 w-[120px]">CGST Amt</th>
                            <th className="px-2 py-3 text-center border border-indigo-200 w-[100px]">SGST %</th>
                            <th className="px-2 py-3 text-center border border-indigo-200 w-[120px]">SGST Amt</th>
                            <th className="px-2 py-3 text-center border border-indigo-200 w-[120px]">Total GST</th>
                            <th className="px-2 py-3 text-center border border-indigo-200 w-[140px]">Grand Total</th>
                            <th className="px-2 py-3 text-center border border-indigo-200 w-[140px]">Debit/Credit</th>
                            <th className="px-2 py-3 text-center border border-indigo-200 w-[100px] rounded-tr-lg">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        {items.map((item, index) => (
                            <tr key={item.id}>
                                ...
                                <td className="px-2 py-3 text-center border border-indigo-200">
                                    <input
                                        type="number"
                                        max={9999}
                                ...
                                <td className="px-2 py-3 text-center border border-indigo-200">
                                    <Dropdown
                                        ...
                                        width="w-full"
                                        initialValue={item.debitCredit}
                                        onSelect={(value) => onUpdateItem(item.id, 'debitCredit', value)}
                                    />
                                </td>
                                <td className="px-2 py-3 text-center border border-indigo-200 rounded-br-lg">
                                    <button
