...
const PartyDueDetails = () => {
    // Dummy Data (You can replace with backend later)
    const partyData = {
        partyName: "TN Traders Pvt Ltd",
        partyCode: "PTYTN1001",
    ...
    const exportToExcel = () => {
        const worksheet = XLSX.utils.json_to_sheet(partyData.transactions);
        const workbook = XLSX.utils.book_new();
        XLSX.utils.book_append_sheet(workbook, worksheet, "Party Transactions");
        XLSX.writeFile(workbook, `${partyData.partyName}_Due_Details.xlsx`);
    };
    ...
    return (
        <div className="bg-gray-50 min-h-screen p-6 font-[Poppins]">
            ...
            <div className="flex items-center mb-8">
                ...
                <h1 className="text-3xl font-bold text-indigo-600">Party Due Details</h1>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                        <InfoRow label="Party Name" value={partyData.partyName} />
                        <InfoRow label="Party Code" value={partyData.partyCode} />
                        <InfoRow label="Contact Person" value={partyData.contactPerson} />
                    </div>
                    <div className="space-y-4">
                        <InfoRow label="Current Due Status" value={partyData.currentDueStatus} valueClass="text-red-600 font-medium" />
                        <InfoRow label="Current Due Amount" value={`₹${partyData.currentDueAmount.toLocaleString('en-IN')}.00`} />
                        <InfoRow label="Due Type" value={`${partyData.debitype}`} />
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {partyData.transactions.map((txn, index) => (
                            <tr key={txn.id}>
...
export default PartyDueDetails;
