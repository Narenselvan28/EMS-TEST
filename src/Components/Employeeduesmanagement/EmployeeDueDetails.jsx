...
const EmployeeDueDetails = () => {
    ...
    const EmployeeData = {
        EmployeeName: "TN Traders Pvt Ltd",
        EmployeeCode: "PTYTN1001",
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                        ...
                        <InfoRow label="Contact Person" value={EmployeeData.contactPerson} />
                    </div>
                    <div className="space-y-4">
                        <InfoRow label="Current Due Status" value={EmployeeData.currentDueStatus} valueClass="text-red-600 font-medium" />
                        <InfoRow label="Current Due Amount" value={`₹${EmployeeData.currentDueAmount.toLocaleString('en-IN')}.00`} />
                        <InfoRow label="Due Type" value={`${EmployeeData.debitype}`} />
