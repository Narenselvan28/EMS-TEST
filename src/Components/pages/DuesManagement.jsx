...
import {
    Wallet,        // For Party Due (representing financial aspect)
    BadgeDollarSign, // For Employee Due (representing financial aspect)
    Building,      // For Vendor Due (representing the vendor entity)
...
function DuesPage() {
    ...
    // Define due options with additional styling properties and icons
    const dueOptions = [
        {
            label: "Party Due",
            path: "/duesmanagement/partyduesmanagement",
            icon: <Wallet className="w-8 h-8 md:w-10 md:h-10 text-indigo-600" />,
            color: "bg-indigo-50",
        ...
        {
            label: "Employee Due",
            path: "/duesmanagement/employeeduesmanagement",
            icon: <BadgeDollarSign className="w-8 h-8 md:w-10 md:h-10 text-blue-600" />,
            color: "bg-blue-50",
        ...
        {
            label: "Vendor Due",
            path: "/duesmanagement/vendorduesmanagement",
            icon: <Building className="w-8 h-8 md:w-10 md:h-10 text-green-600" />,
            color: "bg-green-50",
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 flex flex-col items-center justify-center p-6 sm:p-8 md:p-10">
            {/* WEBSYRA ERP Branding Header (copied from MastersPage for consistency) */}
            <motion.div
            ...
            >
                ...
                <p className="text-lg sm:text-xl text-gray-600 font-light max-w-2xl mx-auto">
                    Manage and track all outstanding dues for your business.
                </p>
            </motion.div>
            ...
            {loading ? (
                ...
                >
                    <div className="text-center mb-10">
                        <h2 className="text-3xl font-bold text-gray-800 mb-3">Dues Management</h2>
                        <p className="text-gray-500 text-md">Select a module to view and manage specific types of dues.</p>
                    </div>
